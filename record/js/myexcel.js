...
ExcelCls.prototype.printExcel = function(type) {
...
ExcelCls.prototype.exportExcel = function(type) {

    function saveAs(tmpDown, fileName) {
        try {
    ...
    let fileName = this.options.title + devicename;
